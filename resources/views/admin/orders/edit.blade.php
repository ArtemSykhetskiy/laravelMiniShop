        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <form method="post" action="{{route('admin.order.update', $order)}}" >
                    ...
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" class="form-control" placeholder="Name" name="name" value="{{$order->name}}">
                    </div>

                    <div class="form-group">
                        <label>Surname</label>
                        <input type="text" class="form-control" placeholder="Surname" name="surname" value="{{$order->surname}}">
                    </div>
                    <div class="form-group" style="margin-top: 25px">
                        <label>Phone</label>
                        <input type="text" class="form-control" placeholder="Phone" name="phone" value="{{$order->phone}}">
                    </div>
                    <div class="form-group" style="margin-top: 25px">
                        <label>Email</label>
                        <input type="text" class="form-control" placeholder="Email" name="email" value="{{$order->email}}">
                    </div>
                    <div class="form-group" style="margin-top: 25px">
                        <label>Country</label>
                        <input type="text" class="form-control" placeholder="Country" name="country" value="{{$order->country}}">
                    </div>
                    <div class="form-group" style="margin-top: 25px">
                        <label>City</label>
                        <input type="text" class="form-control" placeholder="City" name="city" value="{{$order->city}}">
                    </div>
                    <div class="form-group" style="margin-top: 25px">
                        <label>Address</label>
                        <input type="text" class="form-control" placeholder="Adress" name="address" value="{{$order->address}}">
                    </div>
